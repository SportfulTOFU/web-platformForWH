...
!(function(a, b) {
  typeof define === 'function' && define.amd ? define('Chartist', [], function() {
    return a.Chartist = b()
  }) : typeof exports === 'object' ? module.exports = b() : a.Chartist = b()
}(this, function() {
  var a = {
    version: '0.10.0'
  };
  return (function(a, b, c) {
    ...
    c.namespaces = {
      ...
      for (a = a || {}, b = 1; b < arguments.length; b++) {
        d = arguments[b];
        for (var f in d) e = d[f], typeof e !== 'object' || e === null || e instanceof Array ? a[f] = e : a[f] = c.extend(a[f], e)
      }
      return a
      ...
      var d = [];
      var e = Math.max.apply(null, a.map(function(a) {
        return a.length
      }));
      ...
      return a === null || void 0 === a ? a : (typeof a === 'number' ? a = '' + a : typeof a === 'object' && (a = JSON.stringify({
        data: a
      ...
      return a !== null && typeof a === 'object' && a.hasOwnProperty(b)
    }, c.isDataHoleValue = function(a) {
      return a === null || void 0 === a || typeof a === 'number' && isNaN(a)
    }, c.reverseData = function(a) {
      a.labels.reverse(), a.series.reverse();
      for (var b = 0; b < a.series.length; b++) typeof a.series[b] === 'object' && void 0 !== a.series[b].data ? a.series[b].data.reverse() : a.series[b] instanceof Array && a.series[b].reverse()
      ...
      function e(a) {
        ...
        if (!c.isDataHoleValue(a)) {
          if (d) {
            var b = {};
            return typeof d === 'string' ? b[d] = c.getNumberOrUndefined(a) : b.y = c.getNumberOrUndefined(a), b.x = a.hasOwnProperty('x') ? c.getNumberOrUndefined(a.x) : b.x, b.y = a.hasOwnProperty('y') ? c.getNumberOrUndefined(a.y) : b.y, b
          }
      ...
      return b = b || 0, typeof a === 'number' ? {
        ...
        top: typeof a.top === 'number' ? a.top : b,
        right: typeof a.right === 'number' ? a.right : b,
        bottom: typeof a.bottom === 'number' ? a.bottom : b,
        left: typeof a.left === 'number' ? a.left : b
      }
      ...
      var g = void 0 === b.high;
      var h = void 0 === b.low;
      return (g || h) && e(a), (b.referenceValue || b.referenceValue === 0) && (f.high = Math.max(b.referenceValue, f.high), f.low = Math.min(b.referenceValue, f.low)), f.high <= f.low && (f.low === 0 ? f.high = 1 : f.low < 0 ? f.high = 0 : f.high > 0 ? f.low = 0 : (f.high = 1, f.low = 0)), f
      ...
      var f = 2;
      if (a % 2 === 0) return 2;
      do e = c(e) % a, f = c(c(f)) % a, d = b(Math.abs(e - f), a); while (d === 1);
      return d
      ...
      var f = e ? b.axisY.offset : 0;
      var g = e ? b.axisX.offset : 0;
      var h = a.width() || c.quantity(b.width).value || 0;
      var i = a.height() || c.quantity(b.height).value || 0;
      var j = c.normalizePadding(b.chartPadding, d);
      ...
      return e ? (b.axisX.position === 'start' ? (k.y2 = j.top + g, k.y1 = Math.max(i - j.bottom, k.y2 + 1)) : (k.y2 = j.top, k.y1 = Math.max(i - j.bottom - g, k.y2 + 1)), b.axisY.position === 'start' ? (k.x1 = j.left + f, k.x2 = Math.max(h - j.right, k.x1 + 1)) : (k.x1 = j.left, k.x2 = Math.max(h - j.right - f, k.x1 + 1))) : (k.x1 = j.left, k.x2 = Math.max(h - j.right, k.x1 + 1), k.y2 = j.top, k.y1 = Math.max(i - j.bottom, k.y2 + 1)), k
      ...
      return a = c.extend({}, b, a),
        function d(b, e) {
          ...
          if (f.length) {
            ...
            for (m[0] = n[0], m[l - 1] = n[l - 2], h = 1; h < l - 1; h++) n[h] === 0 || n[h - 1] === 0 || n[h - 1] > 0 != n[h] > 0 ? m[h] = 0 : (m[h] = 3 * (p[h - 1] + p[h]) / ((2 * p[h] + p[h - 1]) / n[h - 1] + (p[h] + 2 * p[h - 1]) / n[h]), isFinite(m[h]) || (m[h] = 0));
    ...
    c.EventEmitter = function() {
      ...
      function b(a, b) {
        d[a] && (b ? (d[a].splice(d[a].indexOf(b), 1), d[a].length === 0 && delete d[a]) : delete d[a])
      }
    ...
    function d(a, d, e, f, g) {
      a instanceof Element ? this._node = a : (this._node = b.createElementNS(c.namespaces.svg, a), a === 'svg' && this.attr({
    ...
    function e(a, b) {
      return typeof a === 'string' ? b ? this._node.getAttributeNS(b, a) : this._node.getAttribute(a) : (Object.keys(a).forEach(function(b) {
        if (void 0 !== a[b])
          if (b.indexOf(':') !== -1) {
            var d = b.split(':');
    ...
    function h() {
      for (var a = this._node; a.nodeName !== 'svg';) a = a.parentNode;
      return new c.Svg(a)
    }
    ...
    function m(a) {
      ...
      b[b.length - 1][0].toUpperCase() === 'Z' && b.pop();
      var d = b.map(function(a) {
        var b = a.shift();
        var d = u[b.toLowerCase()];
        return c.extend({
          command: b
    ...
    function s(a) {
      ...
      return this.pathElements.forEach(function(d) {
        d.command === a.toUpperCase() && b[b.length - 1].pathElements.length !== 0 && b.push(new c.Svg.Path()), b[b.length - 1].pathElements.push(d)
      }), b
    }
    ...
    function e(a, b, d, e, f) {
      ...
      var h = this.ticks.map(this.projectValue.bind(this));
      var i = this.ticks.map(g.labelInterpolationFnc);
      h.forEach(function(j, k) {
        ...
        l = h[k + 1] ? h[k + 1] - j : Math.max(this.axisLength - j, 30), c.isFalseyButZero(i[k]) && i[k] !== '' || (this.units.pos === 'x' ? (j = this.chartRect.x1 + j, m.x = e.axisX.labelOffset.x, e.axisX.position === 'start' ? m.y = this.chartRect.padding.top + e.axisX.labelOffset.y + (d ? 5 : 20) : m.y = this.chartRect.y1 + e.axisX.labelOffset.y + (d ? 5 : 20)) : (j = this.chartRect.y1 - j, m.y = e.axisY.labelOffset.y - (d ? l : 0), e.axisY.position === 'start' ? m.x = d ? this.chartRect.padding.left + e.axisY.labelOffset.x : this.chartRect.x1 - 10 : m.x = this.chartRect.x2 + e.axisY.labelOffset.x + 10), g.showGrid && c.createGrid(j, k, this, this.gridOffset, this.chartRect[this.counterUnits.len](), a, [e.classNames.grid, e.classNames[this.units.dir]], f), g.showLabel && c.createLabel(j, l, k, i, this, g.offset, m, b, [e.classNames.label, e.classNames[this.units.dir], g.position === 'start' ? e.classNames[g.position] : e.classNames.end], d, f))
      }.bind(this))
    }
    var f = {
      x: {
    ...
    function d(a) {
      ...
      var d;
      var e;
      var g = this.svg.elem('g').addClass(a.classNames.gridGroup);
      var h = this.svg.elem('g');
      var i = this.svg.elem('g').addClass(a.classNames.labelGroup);
      var j = c.createChartRect(this.svg, a, f.padding);
      d = void 0 === a.axisX.type ? new c.StepAxis(c.Axis.units.x, b.normalized.series, j, c.extend({}, a.axisX, {
        ...
        var n = typeof m.lineSmooth === 'function' ? m.lineSmooth : m.lineSmooth ? c.Interpolation.monotoneCubic() : c.Interpolation.none();
        var o = n(k, l);
    ...
    function d(a) {
      ...
      var g = this.svg.elem('g');
      var h = this.svg.elem('g').addClass(a.classNames.labelGroup);
      if (a.stackBars && b.normalized.series.length !== 0) {
      ...
      d.high = +a.high || (a.high === 0 ? 0 : d.high), d.low = +a.low || (a.low === 0 ? 0 : d.low);
      var j;
      var k;
      var l;
      var m;
      var n;
      var o = c.createChartRect(this.svg, a, f.padding);
      ...
      l.createGridAndLabels(e, h, this.supportsForeignObject, a, this.eventEmitter), j.createGridAndLabels(e, h, this.supportsForeignObject, a, this.eventEmitter), a.showGridBackground && c.createGridBackground(e, o, a.classNames.gridBackground, this.eventEmitter), b.raw.series.forEach(function(d, e) {
        var f;
        var h;
        var i = e - (b.raw.series.length - 1) / 2;
        f = a.distributeSeries && !a.stackBars ? l.axisLength / b.normalized.series.length / 2 : a.distributeSeries && a.stackBars ? l.axisLength / 2 : l.axisLength / b.normalized.series[e].length / 2, h = g.elem('g'), h.attr({
          ...
          if (u = a.distributeSeries && !a.stackBars ? e : a.distributeSeries && a.stackBars ? 0 : k, r = a.horizontalBars ? {
            ...
            var v = {};
            v[l.units.pos + '1'] = r[l.units.pos], v[l.units.pos + '2'] = r[l.units.pos], !a.stackBars || a.stackMode !== 'accumulate' && a.stackMode ? (v[l.counterUnits.pos + '1'] = p, v[l.counterUnits.pos + '2'] = r[l.counterUnits.pos]) : (v[l.counterUnits.pos + '1'] = t, v[l.counterUnits.pos + '2'] = q[k]), v.x1 = Math.min(Math.max(v.x1, o.x1), o.x2), v.x2 = Math.min(Math.max(v.x2, o.x1), o.x2), v.y1 = Math.min(Math.max(v.y1, o.y2), o.y1), v.y2 = Math.min(Math.max(v.y2, o.y2), o.y1);
    ...
    function d(a, b, c) {
      var d = b.x > a.x;
      return d && c === 'explode' || !d && c === 'implode' ? 'start' : d && c === 'implode' || !d && c === 'explode' ? 'end' : 'middle'
    }
    ...
    function e(a) {
      ...
      var h;
      var i;
      var j = c.normalizeData(this.data);
      var k = [];
      var l = a.startAngle;
      ...
      m.unit === '%' && (m.value *= f / 100), f -= a.donut ? m.value / 2 : 0, h = a.labelPosition === 'outside' || a.donut ? f : a.labelPosition === 'center' ? 0 : f / 2, h += a.labelOffset;
      var n = {
        x: e.x1 + e.width() / 2,
        y: e.y2 + e.height() / 2
      };
      var o = j.raw.series.filter(function(a) {
        return a.hasOwnProperty('value') ? a.value !== 0 : a !== 0
      }).length === 1;
      j.raw.series.forEach(function(a, b) {
        ...
        if (j.normalized.series[g] !== 0 || !a.ignoreEmptyValues) {
          k[g].attr({
          ...
          var q = Math.max(0, l - (g === 0 || o ? 0 : 0.2));
          p - q >= 359.99 && (p = q + 359.99);
          var r = c.polarToCartesian(n.x, n.y, f, q);
          var s = c.polarToCartesian(n.x, n.y, f, p);
          var t = new c.Svg.Path((!a.donut)).move(s.x, s.y).arc(f, f, 0, p - l > 180, 0, r.x, r.y);
          ...
          if (u.attr({
            ...
            var v;
            v = j.raw.series.length === 1 ? {
              x: n.x,
              y: n.y
            } : c.polarToCartesian(n.x, n.y, h, l + (p - l) / 2);
            var w;
            w = j.normalized.labels && !c.isFalseyButZero(j.normalized.labels[g]) ? j.normalized.labels[g] : j.normalized.series[g];
