...
if (typeof jQuery === 'undefined') throw new Error("Bootstrap's JavaScript requires jQuery"); +(function(a) {
  ...
  function b(b) {
    var c; var d = b.attr('data-target') || (c = b.attr('href')) && c.replace(/.*(?=#[^\s]+$)/, '')
    return a(d)
  }
  ...
  d.VERSION = '3.3.7', d.TRANSITION_DURATION = 350, d.DEFAULTS = {
    ...
    if (!this.transitioning && !this.$element.hasClass('in')) {
      var b; var e = this.$parent && this.$parent.children('.panel').children('.in, .collapsing')
  ...
  c.VERSION = '3.3.7', c.DEFAULTS = a.extend({}, a.fn.tooltip.Constructor.DEFAULTS, {
    ...
    a.find('.popover-title')[this.options.html ? 'html' : 'text'](b), a.find('.popover-content').children().detach().end()[this.options.html ? typeof c === 'string' ? 'html' : 'append' : 'text'](c), a.removeClass('fade top bottom left right in'), a.find('.popover-title').html() || a.find('.popover-title').hide()
  }, c.prototype.hasContent = function() {
  ...
  b.VERSION = '3.3.7', b.DEFAULTS = {
    ...
    var a; var b = this.$scrollElement.scrollTop() + this.options.offset
